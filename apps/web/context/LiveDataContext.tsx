...
type Incident = { id: string; type: string; location: string; time: string; status: 'Active' | 'Dispatched' | 'Resolved'; severity: string; units: string[]; latitude?: number; longitude?: number; victims?: number; hazards?: string[]; summary?: string; confidence?: number; };
